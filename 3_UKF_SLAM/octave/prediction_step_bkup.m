...
for i=1:2*n+1
    sigma_points(1:3,i) = sigma_points(1:3,i) + [u.t*cos(normalize_angle(sigma_points(3,i) + u.r1)); u.t*sin(normalize_angle(sigma_points(3,i) + u.r1)); normalize_angle(u.r1 + u.r2)];
endfor
...
for i=1:2*n+1
    sigma = sigma + wc(i)*(sigma_points(1:end,i) - mu)*(sigma_points(1:end,i) - mu)';
endfor
